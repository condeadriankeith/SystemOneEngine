"""Kaggle Training Bundle & Notebook Generator.

Generates a 100% self-contained Jupyter Notebook (`kaggle_system_one_training.ipynb`)
ready to be uploaded and run on Kaggle GPU instances (NVIDIA Dual T4 or P100).
"""
...
def generate_kaggle_notebook(output_path: str | Path = "kaggle_system_one_training.ipynb") -> Path:
    """Generate the complete, self-contained Kaggle training notebook.

    Args:
        output_path: Destination path for the .ipynb notebook file.

    Returns:
        Path: Path to written notebook.
    """
    ...
    cells = [
        ...
        # Cell 4: Training & Calibration Pipeline
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {},
